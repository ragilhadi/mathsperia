...
export const COMMON_ANGLES: TrigTableEntry[] = [
	...
	{ degrees: 30, radians: '\\frac{\\pi}{6}', sin: 0.5, cos: Math.sqrt(3) / 2, tan: Math.sqrt(3) / 3 },
	...
	{ degrees: 120, radians: '\\frac{2\\pi}{3}', sin: Math.sqrt(3) / 2, cos: -0.5, tan: -Math.sqrt(3) },
	{ degrees: 135, radians: '\\frac{3\\pi}{4}', sin: Math.sqrt(2) / 2, cos: -Math.sqrt(2) / 2, tan: -1 },
	{ degrees: 150, radians: '\\frac{5\\pi}{6}', sin: 0.5, cos: -Math.sqrt(3) / 2, tan: -Math.sqrt(3) / 3 },
	{ degrees: 180, radians: '\\pi', sin: 0, cos: -1, tan: 0 },
	{ degrees: 210, radians: '\\frac{7\\pi}{6}', sin: -0.5, cos: -Math.sqrt(3) / 2, tan: Math.sqrt(3) / 3 },
	{ degrees: 225, radians: '\\frac{5\\pi}{4}', sin: -Math.sqrt(2) / 2, cos: -Math.sqrt(2) / 2, tan: 1 },
	{ degrees: 240, radians: '\\frac{4\\pi}{3}', sin: -Math.sqrt(3) / 2, cos: -0.5, tan: Math.sqrt(3) },
	{ degrees: 270, radians: '\\frac{3\\pi}{2}', sin: -1, cos: 0, tan: -Infinity },
	{ degrees: 300, radians: '\\frac{5\\pi}{3}', sin: -Math.sqrt(3) / 2, cos: 0.5, tan: -Math.sqrt(3) },
	{ degrees: 315, radians: '\\frac{7\\pi}{4}', sin: -Math.sqrt(2) / 2, cos: Math.sqrt(2) / 2, tan: -1 },
	{ degrees: 330, radians: '\\frac{11\\pi}{6}', sin: -0.5, cos: Math.sqrt(3) / 2, tan: -Math.sqrt(3) / 3 },

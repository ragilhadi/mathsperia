...
export const GLOSSARY: GlossaryTerm[] = [
	...
	{
		term: 'Altitude',
		definition: 'The perpendicular distance from the base of a shape to its opposite vertex (height).',
		category: 'General',
		relatedShape: 'triangle',
		seeAlso: ['Height']
	},
	{
		term: 'Area',
		definition: 'The measure of the two-dimensional surface enclosed by a shape. Measured in square units.',
	...
	{
		term: 'Base',
		definition: 'The side of a polygon or face of a solid on which the shape rests. Often used as the reference side for calculating area.',
		category: 'General',
		seeAlso: ['Altitude', 'Height']
	},
	{
		term: 'Circle',
		definition: 'A shape consisting of all points in a plane that are at a given distance (radius) from a center point.',
		category: 'Shapes',
		relatedShape: 'circle',
		formula: 'A = πr², C = 2πr',
	...
	{
		term: 'Circumference',
		definition: 'The distance around the outside of a circle. Equivalent to the perimeter of a circle.',
		category: 'Measurements',
		relatedShape: 'circle',
		formula: 'C = 2πr = πd',
	...
	{
		term: 'Congruent',
		definition: 'Having the same size and shape. Two figures are congruent if they can be mapped onto each other by rigid transformations.',
		category: 'General',
		seeAlso: ['Similar']
	},
	{
	...
	{
		term: 'Diameter',
		definition: 'The distance across a circle passing through its center. Equal to twice the radius.',
		category: 'Measurements',
		relatedShape: 'circle',
		formula: 'd = 2r',
	...
	{
		term: 'Ellipse',
		definition: 'A closed curve where the sum of the distances from any point on the curve to two fixed points (foci) is constant.',
		category: 'Shapes',
	...
	},
	{
		...
		definition: 'A formula to find the area of a triangle from its three side lengths without needing to know the height.',
		category: 'Formulas',
	...
	{
		term: 'Kite',
		definition: 'A quadrilateral with two pairs of adjacent sides that are equal in length. The diagonals intersect at right angles.',
		category: 'Shapes',
		relatedShape: 'kite',
		formula: 'A = (d₁ × d₂)/2',
	...
	},
	{
		...
		definition: 'A line that divides a shape into two identical halves that are mirror images of each other.',
		category: 'General',
		seeAlso: ['Reflection']
	},
	{
	...
	{
		term: 'Pi (π)',
		definition: 'A mathematical constant approximately equal to 3.14159. The ratio of a circle\'s circumference to its diameter.',
		category: 'Constants',
		seeAlso: ['Circle', 'Circumference']
	},
	{
		term: 'Polygon',
		definition: 'A closed two-dimensional shape formed by straight line segments. Examples include triangles, squares, and pentagons.',
		category: 'General',
	...
	{
		term: 'Quadrilateral',
		definition: 'A polygon with four sides and four angles. The sum of interior angles is always 360 degrees.',
		category: 'Polygons',
	...
	{
		term: 'Rhombus',
		definition: 'A quadrilateral with all four sides equal in length. Opposite sides are parallel and opposite angles are equal.',
		category: 'Shapes',
	...
	},
	{
		...
		definition: 'A method for calculating the area of a polygon when the coordinates of its vertices are known.',
		category: 'Formulas',
	...
	{
		term: 'Similar',
		definition: 'Two figures are similar if they have the same shape but not necessarily the same size. Corresponding angles are equal and sides are proportional.',
		category: 'General',
		seeAlso: ['Congruent']
	},
	{
		term: 'Slope',
		definition: 'The measure of the steepness of a line, calculated as the change in y divided by the change in x.',
	...
	{
		term: 'Volume',
		definition: 'The amount of three-dimensional space enclosed by a shape. Measured in cubic units.',
		category: 'Measurements',
		seeAlso: ['Surface area', 'Area']
	},
	{
		term: 'Coordinate geometry',
		definition: 'The study of geometry using a coordinate system, enabling algebraic methods to solve geometric problems.',
		category: 'Coordinate geometry',
	...
	},
	{
		...
		definition: 'A formula derived from the Pythagorean theorem that calculates the distance between two points in a coordinate plane.',
		category: 'Formulas',
		formula: 'd = √((x₂-x₁)² + (y₂-y₁)²)',
	...
	{
		term: 'Unit circle',
		definition: 'A circle with radius 1 centered at the origin of a coordinate system. Used to define trigonometric functions.',
		category: 'Trigonometry',
		seeAlso: ['Sine', 'Cosine', 'Tangent']
	},
	{
		term: 'Sine',
		definition: 'In a right triangle, the ratio of the opposite side to the hypotenuse. On the unit circle, it is the y-coordinate.',
		category: 'Trigonometry',
	...
	{
		term: 'Cosine',
		definition: 'In a right triangle, the ratio of the adjacent side to the hypotenuse. On the unit circle, it is the x-coordinate.',
		category: 'Trigonometry',
	...
	{
		term: 'Tangent',
		definition: 'In a right triangle, the ratio of the opposite side to the adjacent side. It equals sine divided by cosine.',
		category: 'Trigonometry',

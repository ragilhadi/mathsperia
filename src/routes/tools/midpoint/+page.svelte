<script lang="ts">
	...
	const pageData = mathSolverData({
		...
		resultType: 'midpoint',
		keywords:
			'midpoint calculator, midpoint of two points, coordinate geometry, midpoint formula'
	});
...
<Breadcrumb
	items={[{ label: tKey('nav.home'), href: '/' }, { label: tKey('nav.tools'), href: '/tools' }, { label: tKey('pages.midpoint.title') }]}
/>

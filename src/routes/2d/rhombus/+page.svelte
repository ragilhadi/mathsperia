...
<Breadcrumb
	items={[
		...
		{ label: tKey('shapes.rhombus.name') }
	]}
/>
...
<div class="mb-8">
	...
	<h1 class="font-display text-4xl font-bold tracking-tight text-text-primary">
		{tKey('shapes.rhombus.name')}
	</h1>
	<p class="mt-2 text-text-secondary">{tKey('shapes.rhombus.desc')}</p>
</div>
...
<div class="grid grid-cols-1 items-start gap-6 lg:grid-cols-2">
	...
	<div class="surface-panel flex flex-col gap-6 p-6">
		<div class="flex flex-col gap-4">
			...
			<SliderInput
				label={tKey('shapes.rhombus.diagonal1')}
			...
			/>
			<SliderInput
				label={tKey('shapes.rhombus.diagonal2')}
		...
		<CalculationHistory shapeId="rhombus" />
	</div>
</div>

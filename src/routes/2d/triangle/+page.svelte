<script lang="ts">
	...
	const pageData = categoryPageData({
		...
		urlPath: '/2d/triangle',
		description:
			'Interactive triangle calculators for all triangle types — equilateral, isosceles, right, and scalene.',
		itemList: [
	...
	const triangleTypes = [
		{
			...
			svgPreview:
				'<svg viewBox="0 0 100 100" class="w-16 h-16"><polygon points="50,18 86,78 14,78" fill="none" stroke="#818CF8" stroke-width="2"/></svg>'
		},
		{
			name: 'Isosceles',
			...
			svgPreview:
				'<svg viewBox="0 0 100 100" class="w-16 h-16"><polygon points="50,22 82,80 18,80" fill="none" stroke="#818CF8" stroke-width="2"/></svg>'
		},
		{
			name: 'Right Triangle',
			...
			svgPreview:
				'<svg viewBox="0 0 100 100" class="w-16 h-16"><polygon points="22,78 22,34 74,78" fill="none" stroke="#818CF8" stroke-width="2"/></svg>'
		},
		{
			name: 'Scalene',
			...
			svgPreview:
				'<svg viewBox="0 0 100 100" class="w-16 h-16"><polygon points="24,76 48,20 84,80" fill="none" stroke="#818CF8" stroke-width="2"/></svg>'
		}
	];
</script>
...
<p class="mb-10 text-text-secondary">Different types have specific calculation methods.</p>
